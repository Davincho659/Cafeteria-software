...
class LoginController {
    ...
    public function authenticate() {
        ...
        try {
            ...
            // (que un atacante fije un ID conocido antes del login).
    ...
    /**
     * Devuelve un token CSRF fresco para la sesión actual.
     *
     * Lo usa el wrapper de fetch para recuperarse solo cuando un token quedó
     * obsoleto (sesión reiniciada, servidor reiniciado). Sin esto, el cajero
     * vería "sesión expirada" y tendría que recargar — inaceptable en un POS
     * que vive en pantalla completa todo el día.
     *
     * No es un riesgo: la política de mismo origen del navegador impide que
     * otro sitio lea esta respuesta.
     */
