...
class ExpensesController {
    ...
    public function createProductExpense() {
        ...
        try {
            ...
            $cantidad = Validator::cantidad($data['cantidad'] ?? null, false, 'La cantidad del gasto');
            $motivo = trim($data['motivo']);
            // El monto es opcional (si no viene, se calcula por costo del producto)
            $monto = isset($data['monto']) && $data['monto'] !== ''
                ? Validator::monto($data['monto'], 'El monto del gasto')
                : null;
    ...
    public function createExternalExpense() {
        ...
        try {
            ...
            $monto = Validator::monto($data['monto'] ?? null, 'El monto del gasto');
