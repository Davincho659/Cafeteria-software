                ...
                <div class="col-md-3">
                    <div class="filter-group">
                        ...
                        <select name="metodoPago" class="filter-select">
                            ...
                            <option value="transferencia">Transferencias (Bancolombia + Nequi)</option>
                        </select>
                    </div>
                </div>
        ...
        <div class="row g-3 kpi-row" id="kpi-container">
            ...
            <div class="col-12 col-md-4 col-lg-3">
                <div class="kpi-card">
                    ...
                    <div class="kpi-value text-danger" id="kpi-total-anulado">$0</div>
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="kpi-card">
                    <div class="kpi-label">Facturas anuladas</div>
                    <div class="kpi-value text-danger" id="kpi-cantidad-anuladas">0</div>
                </div>
            </div>
        </div>
